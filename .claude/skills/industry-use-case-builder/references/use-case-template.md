...
---
# Modelo de seção de caso de uso do setor

Cada caso de uso em um arquivo de visão geral do setor segue essa estrutura exata.
...
### Exemplo Emergente (Assistência Médica)
