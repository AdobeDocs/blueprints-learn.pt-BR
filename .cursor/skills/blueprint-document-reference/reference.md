...
|------|---------|--------------------|
| **Visão geral/hub** | Apresenta um produto ou área; links para blueprints de cenário | e.g. `overview.md`, `journey-optimizer-overview.md` |
...
| **Considerações sobre a implementação** | Quando houver avisos importantes | Subseções (por exemplo, Considerações de identidade, Personalização baseada em atributos). Marcadores ou parágrafos curtos; vincule para fora quanto à profundidade. |
