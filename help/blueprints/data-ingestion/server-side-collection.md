...
O blueprint do encaminhamento de eventos mostra como os dados coletados com SDKs da Web e móvel do Adobe [!DNL Experience Platform] podem ser encaminhados de [!DNL Experience Platform] [!DNL Edge Network] para um destino desejado. É possível encaminhar todos os dados brutos coletados dos SDKs ou dados específicos com base em eventos e regras configurados nas propriedades de tag (antigo Launch).
...
* [Simplificando os Fluxos de Trabalho do Cliente com o Adobe [!DNL Experience Platform] SDK da Web](https://medium.com/adobetech/simplifying-customer-workflows-with-adobe-experience-platform-web-sdk-4e54fe134f4a)
