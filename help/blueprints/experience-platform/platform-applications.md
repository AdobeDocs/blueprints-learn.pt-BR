...
<img src="assets/aep+apps_vertical.svg" alt="Experience Platform e aplicativos" style="border:1px solid #4a4a4a; width:90%; margin-bottom: 15px;" />

## Adobe Experience Platform e diagrama detalhado de arquitetura de aplicativos

<img src="assets/aep-app-architecture.svg" alt="Experience Platform e aplicativos" style="border:1px solid #4a4a4a; width:90%; margin-bottom: 15px;" />
