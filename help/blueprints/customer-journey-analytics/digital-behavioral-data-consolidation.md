...
1. Assimilar dados[Tutorial de Dados de Assimilar](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2020.1.dataingestion&amp;lang=pt-BR) no Experience Platform.
Os dados devem ser assimilados na Platform antes de processá-los no Customer Journey Analytics. Para obter mais informações sobre a assimilação de dados e os tipos de fontes de dados, consulte a documentação a seguir. [Fontes ](https://experienceleague.adobe.com/docs/experience-platform/sources/home.html?lang=pt-BR) de dados, incluindo o conector de dados  [do Analytics](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html?lang=pt-BR)
1. Analise em união conjuntos de dados de eventos entre canais para garantir que eles tenham uma ID de namespace comum ou sejam rechaveados por meio da funcionalidade de adesão com base nos campos do Customer Journey Analytics. Consulte a documentação de análise entre canais para obter mais informações sobre a identificação no Customer Journey Analytics. [Identificação de identidade](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/cca/overview.html?lang=en)
