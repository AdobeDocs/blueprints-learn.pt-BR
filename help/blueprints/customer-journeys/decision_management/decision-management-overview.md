---
title: Visão geral do gerenciamento de decisões
...
# Journey Optimizer - Visão geral do gerenciamento de decisões
...
<img src="../assets/offers_overview.png" alt="Gerenciamento de decisões" style="width:100%; border:1px solid #4a4a4a" />
...
* [Descrição do produto Gerenciamento de decisão do Adobe](https://helpx.adobe.com/br/legal/product-descriptions/offer-decisioning-app-service.html)