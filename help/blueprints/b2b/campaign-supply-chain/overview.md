...
## Como entender como as iniciativas de marketing são representadas no Workfront {#understanding-how-marketing-initiatives-are-represented-in-workfront}
...
<table> 
  ...
  <tr>
   ...
   (Por exemplo, uma tarefa para criar um segmento de público ou um rascunho de email pode ser associada a um projeto para desenvolver um programa de email do Marketo Engage.)</td>
  </tr>
  <tr>
   <td>Problema</td>
