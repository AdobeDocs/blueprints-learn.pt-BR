...
| **[Comprando o Gerenciamento de Jornada e Marketing Baseado em Grupo](./b2b-buying-group-journeys.md)** | <ul><li>Projetar e criar uma jornada de conta que qualifique leads para um grupo de compras que aumente a eficácia da atividade de marketing na qualificação de leads para oportunidades de vendas</li></ul> | <ul><li>Adobe Journey Optimizer B2B edition</li><li>Edição B2B da Adobe Real-time Customer Data Platform</li><li>Adobe Marketo Engage</li></ul> |
