...
|---|---|---|
| **[Análise B2B](b2bactivation.md)** | <ul><li>Incluir informações da conta B2B na análise de jornada do cliente</li></ul> | <ul><li>Adobe Customer Journey Analytics</li></ul> |
