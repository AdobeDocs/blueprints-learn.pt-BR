...
![Opções do agendador para a frequência com que o fluxo de trabalho de campanha executa &quot;Opções do agendador&quot;](assets/create-an-orchestrated-campaign-scheduler-options.png "Opções do agendador")
