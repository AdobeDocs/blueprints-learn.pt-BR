...
![Entrada e criação de blueprint](/help/blueprints/b2b/marketo-engage-and-workfront-integration-blueprint/assets/intake-and-create-1.png){zoomable="yes"}
...
<table> 
  ...
  <tr> 
   ...
   <td>· Assunto do e-mail<br />
· Data Programada<br />
· Cópia de e-mail<br />
· Call to action<br />
· Imagem(s) - Os URLs do AEM Assets podem ser referenciados diretamente para uso no Marketo<br />
...
· Página de gravação do webinário - PageURL OnDemand<br />
· Nomes dos alto-falantes<br />
· Títulos dos palestrantes<br />
· Imagens de alto-falantes<br />
· Emails Necessários (Convite, Confirmação, Lembrete, Acompanhamento)<br />
· Imagem(s) de cabeçalho de email<br />
· Critérios de qualificação de público-alvo</td>
  </tr>
  <tr>
   <td>Nutrição</td>
   <td>· Número de e-mails<br />
· Cópia de e-mail<br />
...
![Usar tokens para popular o diagrama de conteúdo](/help/blueprints/b2b/marketo-engage-and-workfront-integration-blueprint/assets/intake-and-create-2.png){zoomable="yes"}
...
![Fluxo de automação de entrada e criação](/help/blueprints/b2b/marketo-engage-and-workfront-integration-blueprint/assets/intake-and-create-3.png)
