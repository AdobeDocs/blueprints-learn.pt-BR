...
| Relatórios e análise | Incluído | Esse padrão é, em si, um padrão de análise. Essa função é incluída inerentemente, pois a cadeia de funções principal fornece recursos de relatório e análise. | [visão geral do CJA](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-overview) |
...
- [!DNL CJA] A licença do B2B edition está ativa e provisionada para a organização
- [!DNL RT-CDP] A licença do B2B edition está ativa com esquemas B2B e perfis de conta configurados
- Os esquemas XDM B2B são definidos (Conta, Oportunidade, Relação pessoal da conta, Relação pessoal da oportunidade, Membros da lista de marketing)
- [!DNL Marketo Engage] e/ou conectores de origem do CRM estão configurados e assimilam dados ativamente
- Os dados de evento comportamentais a nível de conta (visitas da Web, interações de email, envios de formulários) estão fluindo para o AEP com a associação da conta
- As relações pessoa-conta são estabelecidas no gráfico de identidade
- Pelo menos 30 dias de dados históricos do engajamento B2B estão disponíveis para análise significativa
- As partes interessadas chegaram a acordo sobre as definições de funções de grupo de compras e os mapeamentos de interesse da solução
...
- [Esquemas do B2B edition](https://experienceleague.adobe.com/en/docs/experience-platform/rtcdp/schemas/b2b)
...
- [!DNL CJA] conexões podem incluir conjuntos de dados de apenas uma sandbox da AEP — [medidas de proteção da CJA](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-admin/guardrails)
...
- [Esquemas do B2B edition](https://experienceleague.adobe.com/en/docs/experience-platform/rtcdp/schemas/b2b)
- [Visão geral das fontes B2B](https://experienceleague.adobe.com/en/docs/experience-platform/rtcdp/sources/b2b)
