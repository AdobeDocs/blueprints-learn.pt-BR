...
**Recurso do aplicativo:** [!DNL RT-CDP]: Avaliação de público-alvo
...
**Recurso do aplicativo:** [!DNL AJO]: Configuração de canal
...
**Recurso do aplicativo:** [!DNL AJO]: decisão
...
**Recurso do aplicativo:** [!DNL AJO]: Criação de Mensagens
...
**Recurso do aplicativo:** [!DNL AJO]: Journey Orchestration, [!DNL AJO]: Gerenciamento de Conflitos e Prioridades, [!DNL AJO]: Frequência e Regras de Negócios
...
**Recurso do aplicativo:** [!DNL AJO]: Relatórios e Análise de Desempenho
...
- Máximo de 500 jornadas ativas por sandbox — [medidas de proteção do Journey Optimizer](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/guardrails)
