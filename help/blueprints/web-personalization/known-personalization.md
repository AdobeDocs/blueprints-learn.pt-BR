...
* Adobe Analytics ou Customer Journey Analytics (opcional): Adiciona a capacidade de criar segmentos com base em dados históricos de clientes e comportamentos com segmentação detalhada
...
* Para uso no SDK móvel, a variável [Adobe Journey Optimizer - Extensão de decisão](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-journey-optimizer-decisioning) deve ser instalado no SDK móvel.
...
1. Implementar [Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=pt-BR) ou [Experience Platform Mobile SDK](https://aep-sdks.gitbook.io/docs/) com a extensão correta (Target ou Adobe Journey Optimizer - Decisioning) instalada. O Experience Platform Web/Mobile SDK ou a API EDGE são necessários para a segmentação de Edge em tempo real, mas não para o compartilhamento de públicos de streaming e lote do Real-time Customer Data Platform para o Target.
...
* O compartilhamento de públicos do Adobe Experience Platform para a Adobe Target requer o uso da ECID como uma identidade ao usar o serviço de compartilhamento de público, conforme descrito nos padrões de integração 2 e 3 acima.
* Identidades alternativas também podem ser usadas para compartilhar públicos-alvo da Experience Platform com o Adobe Target por meio do Audience Manager. A Experience Platform ativa públicos-alvo para o Audience Manager por meio dos seguintes namespaces compatíveis: IDFA, GAID, AdCloud, Google, ECID, EMAIL_LC_SHA256. Observe que o Audience Manager e o Target resolvem associações de público-alvo por meio da identidade da ECID, portanto, a ECID ainda precisa estar no gráfico de identidade do consumidor para o compartilhamento de público-alvo final com a Adobe Target.
