...
<img src="assets/behavioral_personalization.png" alt="Arquitetura de referência para Blueprint de personalização da Web com base comportamental" style="width:80%; border:1px solid #4a4a4a" />
