...
<img src="assets/behavioral_personalization.svg" alt="Arquitetura de referência para Blueprint de personalização da Web com base comportamental" style="width:90%; border:1px solid #4a4a4a; margin-bottom: 15px;" />
