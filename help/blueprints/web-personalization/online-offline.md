...
## Arquitetura para o cenário 1 e 2 - Streaming em tempo real e Compartilhamento de público em lote pela Edge Network
...
### Etapas de implementação do Cenário 1, também compatível com o cenário 2
...
## Arquitetura do cenário 3 - Streaming e compartilhamento em lote de público-alvo por meio do serviço de compartilhamento de público-alvo para Adobe Target e Audience Manager
...
### Padrão de implementação 2 - Oferece suporte aos casos de uso 3 e 2. SDKs específicos do aplicativo
