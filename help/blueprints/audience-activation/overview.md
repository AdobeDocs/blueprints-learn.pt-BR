---
title: Planos de ativação de público-alvo e perfil
...
# Planos de ativação de público-alvo e perfil
...
## Visão geral da segmentação e do destino
...
## Gráficos de proteção para o público-alvo e esquemas de ativação de perfil
