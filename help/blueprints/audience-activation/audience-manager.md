...
>[!TIP]
>Este blueprint também está disponível como um [padrão de caso de uso](/help/blueprints/use-case-patterns/personalization/anonymous-visitor-web-personalization.md) no Personalization.
...
![Arquitetura de referência para o Blueprint do Audience Activation Anônimo](assets/anonymous_activation.svg)
