...
1. **Links de objetivo comercial** — Cada link de objetivo comercial no arquivo padrão aponta para um arquivo existente em `/help/blueprints/business-objectives/`. Use a pesquisa de espaço de trabalho ou a leitura de arquivo para confirmar se cada arquivo de destino existe.
