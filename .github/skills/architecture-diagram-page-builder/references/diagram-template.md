...
- **Links do Experience League** — URLs absolutas começando com `https://experienceleague.adobe.com/`. Prefira o URL do documento canônico a uma variante localizada.
